...
const ChatPage = () => {
  return (
    <>
      ...
      <div className="hidden md:grid h-full max-w-56 text-center mx-auto place-content-center items-center">
        <FaSignalMessenger className="mx-auto text-primary-main" size={200} />

        <p className="text-sm mt-5 text-primary-main">
          Welcome to Chat App! Start a new chat or select an existing one to get
          started.
        </p>
      </div>
